...
//Display Results 
     ...
     cout<<"First one to $12000.00 wins."<<endl;//Game Rules
    ...
    cout<<Plyrnm<<"'s temporary total is $"<<TmpTtl*CVN<<endl;
    ...
    cout<<endl;
    cout<<"The banks temporary total is $"<<TmpTtl*CVN<<endl;
    ...
    cout<<"Therefore the banks total banked is $"<<BnkScr*CVN<<endl;
    cout<<endl;//Skip a line
    ...
    if(PlyrScr<12*CVN&&BnkScr<12*CVN){//Condition
    cout<<"No winner"<<endl;
